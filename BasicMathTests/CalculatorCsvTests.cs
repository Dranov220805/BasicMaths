...
namespace BasicMathTests
{
    public class CalculatorCsvTests
    {
        ...
        [Theory]
        [MemberData(nameof(GetTestData), parameters: "TestData/add_testdata.csv")]
        ...
        [Theory]
        [MemberData(nameof(GetTestData), parameters: "TestData/subtract_testdata.csv")]
        ...
        [Theory]
        [MemberData(nameof(GetTestData), parameters: "TestData/multiply_testdata.csv")]
        ...
        [Theory]
        [MemberData(nameof(GetTestData), parameters: "TestData/divide_testdata.csv")]
